...
const callbackUrl = 'https://wso2am-admhabits.cloud.okteto.net:8082/devportal/services/auth/callback/login';
...
async function getSettings() {
    const res = await fetch('https://wso2am-admhabits.cloud.okteto.net:9443/api/am/devportal/v2/settings', { agent });
