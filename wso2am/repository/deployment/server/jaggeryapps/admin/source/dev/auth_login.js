...
const callbackUrl = 'https://wso2am-admhabits.cloud.okteto.net:8081/admin/services/auth/callback/login';
...
async function getSettings() {
    const res = await fetch('https://wso2am-admhabits.cloud.okteto.net:9443/api/am/admin/v2/settings', { agent });
